...
public abstract class BaseTable implements Table {
    ...
    public double getBill() {
        double foodPriceTotal = this.foodOrders.stream().mapToDouble(BakedFood::getPrice).sum();
        double drinkPriceTotal = this.drinkOrders.stream().mapToDouble(Drink::getPrice).sum();
        return foodPriceTotal + drinkPriceTotal + this.getPrice();
    }
